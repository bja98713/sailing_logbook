# Generated by Django 4.2.24 on 2025-10-07 09:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nautical', '0013_add_sujet_voyage'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sujet_voyage', models.CharField(help_text='Ex: Séjour à Moorea, Visite des Tuamotu', max_length=200, verbose_name='Sujet du voyage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voyage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conditions_meteo', to='nautical.voyagelognew')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SecurityInstruction',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titre', models.CharField(max_length=200, verbose_name='Titre de la consigne')),
                ('description', models.TextField(verbose_name='Description détaillée')),
                ('priorite', models.CharField(choices=[('basse', 'Basse'), ('normale', 'Normale'), ('haute', 'Haute'), ('critique', 'Critique')], default='normale', max_length=20, verbose_name='Priorité')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('voyage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consignes_securite', to='nautical.voyagelognew')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cap_compas', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(360)], verbose_name='Cap compas (°)')),
                ...
                ('voyage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='nautical.voyagelognew')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_entry', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='incidents', to='nautical.logentrynew')),
                ('personnes_concernees', models.ManyToManyField(blank=True, to='nautical.crewmembernew', verbose_name='Personnes concernées')),
                ('voyage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incidents', to='nautical.voyagelognew')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='voyage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipage', to='nautical.voyagelognew'),
        ),
    ]
